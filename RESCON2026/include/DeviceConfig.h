...
namespace DeviceConfig_RRC23
{
	...
	const s3d::Array<DeviceInfo> g_devices_RRC23 =
	{
		...
		{ U"三号機", DeviceType::RaspberryPi, U"192.168.23.1", U"192.168.23.113", 0, 0, 9003},
	...
	{
		{ U"一号機", DeviceType::RaspberryPi, U"192.168.0.111", U"192.168.0.1", 8081, 8091, 9001 },//IPアドレス：192.168.0.1と送受信
		{ U"二号機", DeviceType::RaspberryPi, U"192.168.0.112", U"192.168.0.2", 8082, 8092, 9001 },//IPアドレス：192.168.0.2と送受信
		{ U"三号機", DeviceType::TPIP4,       U"192.168.0.200", U"-", 0, 0, 9001 },
		{ U"四号機", DeviceType::TPIP4,       U"192.168.0.200", U"-", 0, 0, 9001 },
	};
